...
class BaseBootstarp
{
    ...
    public static function initBase(Dispatcher $dispatcher)
    {
        ...
        } elseif (!ctype_alnum(self::$appConfigs['application']['dispatcher']['defaultModule'])) {
        ...
        } elseif (!ctype_alnum(self::$appConfigs['application']['dispatcher']['defaultController'])) {
        ...
        } elseif (!ctype_alnum(self::$appConfigs['application']['dispatcher']['defaultAction'])) {
