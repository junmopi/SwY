...
class JsPayConfig extends WxBaseShop
{
    ...
    public function __construct(string $appId, string $merchantType = 'self')
    {
        parent::__construct();
    ...
    public function getDetail() : array
    {
        ...
        $this->reqData['paySign'] = WxUtilShop::createSign($this->reqData, $this->reqData['appId'], $this->merchantType);
        return $this->reqData;
    }
}
