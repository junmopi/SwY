...
class MsgNewTmpDelete extends WxBaseMini
{
    /**
     * 应用ID
     * @var string
    ...
    {
        parent::__construct();
        $this->serviceUrl = 'https://api.weixin.qq.com/wxaapi/newtmpl/deltemplate?access_token=';
        $this->appId = $appId;
    ...
    public function setTemplateId(string $templateId)
    {
        if (strlen($templateId) > 0) {
            $this->reqData['priTmplId'] = $templateId;
        } else {
    ...
    {
        if (!isset($this->reqData['priTmplId'])) {
