...
class ErrorCode
{
    ...
    //易联云打印机错误,取值范围:106300-106399
    const YLY_PRINT_PARAM_ERROR = 106300;
    const YLY_PRINT_POST_ERROR = 106300;
    const YLY_PRINT_GET_ERROR = 106300;
    ...
    protected static $msgArr = [
        ...
        self::YLY_PRINT_PARAM_ERROR => '易联云打印机参数错误',
        self::YLY_PRINT_POST_ERROR => '易联云发送POST请求出错',
        self::YLY_PRINT_GET_ERROR => '易联云发送GET请求出错',
    ];
